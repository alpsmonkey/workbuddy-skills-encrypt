# WorkBuddy Skills Encrypt — USB Dongle Protection System

A physical USB dongle encryption system for WorkBuddy Agent skills. Uses RSA-2048 digital signatures + AES-256 content encryption to prevent unauthorized copying of your skill files.
